...
DISEASE_RULES = (
    ...
    (("埃博拉", "ebola"), "ebola-virus-disease", "埃博拉", "Ebola virus disease", None),
    (("麻疹", "measles"), "measles", "麻疹", "Measles", None),
    (("钩端螺旋体", "leptospira", "leptospirosis"), "leptospirosis", "钩端螺旋体病", "Leptospirosis", None),
    (("李斯特", "listeria", "listeriosis"), "listeriosis", "李斯特菌病", "Listeriosis", None),
    (("沙门氏", "salmonella", "salmonellosis"), "salmonellosis", "沙门氏菌病", "Salmonellosis", None),
    (("创伤弧菌", "vibrio vulnificus"), "vibrio-vulnificus-infection", "创伤弧菌感染", "Vibrio vulnificus infection", None),
    (("儿童急性呼吸道",), "pediatric-acute-respiratory-illness", "儿童急性呼吸道疾病", "Pediatric acute respiratory illness", None),
