(function () {
    ...
    const translations = Object.freeze({
        ...
        "DATA": "数据",
        "Data files": "数据文件",
        "Schema v1 records time, identifier, source, and quality, and publishes a SHA-256 checksum.": "Schema v1 记录时间、标识、来源和质量，并给出 SHA-256 校验值。",
        "Event records are published for consultation. Third-party sources follow their own terms.": "事件记录公开供查阅。第三方来源另从其规定。",
        ...
        "METHOD": "方法",
        "How records are prepared": "记录如何整理",
        "Coordinates": "坐标",
