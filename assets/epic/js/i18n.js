(function () {
    ...
    const translations = Object.freeze({
        ...
        "DATA": "数据",
        "Data files": "数据文件",
        "Schema v1 records time, identifier, source, and quality.": "Schema v1 记录时间、标识、来源和质量。",
        "Search by field": "按字段检索",
        "How records are prepared": "记录如何整理",
        "Some coordinates are given only at country level.": "部分坐标只到国家。",
        "Matched": "命中",
        "Use the versioned files and the schema.": "使用带版本的文件和 Schema。",
        "Records": "记录",
        "Table": "表",
        "Columns": "列",
        "Points": "点",
